     ...
     <div className="bollywoodContainer">
        <div className="left">
          <h2 className="bollywoodHeading">Bollywood </h2>
            {filtered
                .filter((item) => item.id >= 4 && item.id <= 10)
                .map((item) => (
                <> 
          ...
          {filtered
            ...
            <img src='https://d1csarkz8obe9u.cloudfront.net/posterpreviews/red-shoe-product-display-instagram-story-design-template-18f7d9df7f9f67442526b83de76e8fca.mp4?ts=1698318591'></img>
            </div>
        </div>
        </div>
